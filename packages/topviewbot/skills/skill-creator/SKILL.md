...
1. **Builtin** - Pre-installed with TopViewbot (read-only)
2. **Global** - `~/.config/topviewbot/skills/` - Available in all projects
3. **Project** - `.topviewbot/skills/` - Project-specific skills
...
mkdir -p ~/.config/topviewbot/skills/my-skill

# Or for project-specific skill
mkdir -p .topviewbot/skills/my-skill
```
...
```bash
# Skill should be at: ~/.config/topviewbot/skills/my-skill/SKILL.md
ls ~/.config/topviewbot/skills/my-skill/
```

**For project-specific skills**:
```bash
# Skill should be at: .topviewbot/skills/my-skill/SKILL.md
ls .topviewbot/skills/my-skill/
```
