      ...
      autonomous: z
        .object({
          ...
          maxRetries: z
            ...
            .positive()
            .default(3)
            .describe("Maximum retry attempts before asking user (default: 3)"),
          askAfterRetries: z
            .boolean()
            .default(true)
            .describe("Ask user after retries exhausted, otherwise report error (default: true)"),
          allowDoomLoop: z
            .boolean()
            .default(true)
            .describe("Allow automatic handling of doom loops without asking user (default: true)"),
        })
        .optional()
        .describe("Autonomous mode configuration - agent tries alternatives on failure, asks human only when stuck"),
      experimental: z
        .object({
          hook: z
            .object({
