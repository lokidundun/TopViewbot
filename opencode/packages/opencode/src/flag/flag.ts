...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_OPENCODE_SKILLS = truthy("OPENCODE_DISABLE_OPENCODE_SKILLS")
  export const OPENCODE_DISABLE_OPENCODE_MCP = truthy("OPENCODE_DISABLE_OPENCODE_MCP")
...
// This must be evaluated at access time, not module load time,
// because external tooling (like TopViewbot) may set this env var at runtime
...
// This must be evaluated at access time, not module load time,
// because TopViewbot sets this env var at runtime before starting the server
