  ...
  <div class="permission-request" :class="{ responded: isResponded }">
    <div class="permission-header">
      <div class="permission-icon" :class="permissionIcon">
        ...
        <svg
          v-else-if="permissionIcon === 'folder'"
          width="16"
          height="16"
          viewBox="0 0 24 24"
          fill="none"
    ...
    <div v-if="!isResponded" class="permission-actions">
      ...
      >
        <span
          v-if="isSubmitting && responseType === 'reject'"
      ...
      >
        <span
          v-if="isSubmitting && responseType === 'once'"
          class="loading-spinner small"
        ></span>
      ...
      >
        <span
          v-if="isSubmitting && responseType === 'always'"
          class="loading-spinner small"
        ></span>
